...
#define NRF24L01_CS(X)		GPIO_WriteBit(GPIOA,GPIO_Pin_4,(BitAction)(X))
...
void NRF24L01_Interrupt_Init(u8 PreemptionPriority,u8 SubPriority)
{
	...
	GPIO_EXTILineConfig(GPIO_PortSourceGPIOB,GPIO_PinSource1);			//GPIO通道选择，PA12
