...
#define USE_HORIZONTAL 3  //显示模式	0/1竖屏		2/3横屏
...
void LCD_WR_DATA8(u8 dat);//写8位
void LCD_WR_DATA(u16 dat);//写16位
void LCD_WR_REG(u8 dat);//写指令
void LCD_Address_Set(u16 x1,u16 y1,u16 x2,u16 y2);//设置坐标
void LCD_Init(void);//LCD初始化


void LCD_Fill(u16 xsta,u16 ysta,u16 xend,u16 yend,u16 color);//ָ指定区域填充颜色
void LCD_DrawPoint(u16 x,u16 y,u16 color);//在指定位置画一个点
void LCD_DrawLine(u16 x1,u16 y1,u16 x2,u16 y2,u16 color);//在指定位置画线
void LCD_DrawRectangle(u16 x1, u16 y1, u16 x2, u16 y2,u16 color);//在指定位置画矩形
void Draw_Circle(u16 x0,u16 y0,u8 r,u16 color);//在指定位置画圆
